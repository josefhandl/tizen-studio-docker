...
RUN apt install -y --no-install-recommends libwebkitgtk-1.0-0 cpio rpm2cpio
RUN apt install -y --no-install-recommends acl bridge-utils openvpn libfontconfig1 libglib2.0-0 libjpeg-turbo8 libpixman-1-0 libpng12-0 libsdl1.2debian libsm6 libv4l-0 libx11-xcb1 libxcb-icccm4 libxcb-image0 libxcb-randr0 libxcb-render-util0 libxcb-shape0 libxcb-xfixes0 libxi6
...
RUN wget -O /opt/tizen.bin http://download.tizen.org/sdk/Installer/tizen-studio_4.1/web-ide_Tizen_Studio_4.1_ubuntu-64.bin
#ADD tizen.bin /opt/
